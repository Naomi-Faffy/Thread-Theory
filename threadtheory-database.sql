...
-- Create database
CREATE DATABASE IF NOT EXISTS threadtheory;
USE threadtheory;
...
INSERT IGNORE INTO users (name, email, phone, password_hash, user_type, address) VALUES
...
INSERT IGNORE INTO users (name, email, phone, password_hash, user_type, specialty, experience_years, bio, address) VALUES
...
('Sophia Kim', 'sophia.kim@email.com', '+1234567894', '$2a$10$example.hash.for.password123', 'creator', 'Casual & Streetwear', 5, 'Urban fashion enthusiast creating comfortable yet stylish casual wear. My designs blend street culture with contemporary fashion.', 'Studio 2, Creative District, Fashion City, FC 24681'),
...
INSERT IGNORE INTO customers (Custname, Custemail, Custnumber, user_id) 
